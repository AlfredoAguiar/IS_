...
from .views.file_views import GetCarByVinView, UpdateCarView, DeleteCarView, GetAllCarsView_2, GetAllCarsLView_2, GetCarByVinLView
...
urlpatterns = [
    ...
    path('cars/all_L2/', GetAllCarsLView_2.as_view(), name='get_all_cars_2'),
    path('cars/get-car-by-vin/', GetCarByVinView.as_view(), name='get-car-by-vin'),
    path('cars/get-car-by-vinL/', GetCarByVinLView.as_view(), name='get-car-by-vin'),

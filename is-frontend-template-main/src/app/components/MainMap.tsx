...
const LeafleatMap = ({ cities, updatePoint } : { cities: City[], updatePoint: (id: string, latitude: number, longitude: number) => any }) => {
    ...
    const onHandleDragMarkerOver = async (e: any, id: string) => {
        ...
        const idx = clusters.findIndex((cluster: { properties: {id: string | string} }) => String(cluster.properties.id) === String(id))

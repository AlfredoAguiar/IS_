...
def get_coordinates(state_abbr):
    """
    ...
    try:
        ...
        time.sleep(5)
        return get_coordinates(state_abbr)
...
def update_xml_with_coordinates(input_path, output_path):
    ...
    try:
        ...
        for state_element in states_elements:
            ...
            latitude, longitude = get_coordinates(state_abbr)
            time.sleep(1)
...
input_xml_path = "dt/unique_States.xml"
output_xml_path = "dt/unique_States_coordinates.xml"
